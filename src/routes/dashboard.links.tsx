      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Gerencie, reordene, oculte ou exclua os destinos da sua Bio.
          </p>
        </div>
        <Button onClick={() => addBlock("link")}>
      ...
      <div className="space-y-3">
        {links.length === 0 ? (
          <div className="rounded-2xl border border-dashed border-border bg-card/50 p-10 text-center">
            ...
            <Button className="mt-4" onClick={() => addBlock("link")}>
          ...
          return (
            <article key={block.id} className="rounded-2xl border border-border bg-card p-4 sm:p-5">
              <div className="flex items-start gap-3">
                <div className="mt-1 flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-accent">
                ...
                <div className="min-w-0 flex-1 space-y-3">
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <Input
                      ...
                      onBlur={(event) =>
                        patchBlock(block.id, {
                          url: normalizeUrl(block.type, event.target.value) || null,
                        })
                      }
                ...
                <div className="flex shrink-0 flex-wrap justify-end gap-1">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      moveBlock(block.id, Math.min(bundle.blocks.length - 1, index + 1))
                    }
